...
* Merge pull request #315 from VenusProtocol/fix/vpd-1241-certik-audit ([b78a721](https://github.com/VenusProtocol/oracle/commit/b78a721)), closes [#315](https://github.com/VenusProtocol/oracle/issues/315)
...
* Merge pull request #317 from VenusProtocol/develop ([6a5c51d](https://github.com/VenusProtocol/oracle/commit/6a5c51d)), closes [#317](https://github.com/VenusProtocol/oracle/issues/317)
* chore: update yarn lock ([adf1a07](https://github.com/VenusProtocol/oracle/commit/adf1a07))
* chore: update yarn.lock ([c1f924a](https://github.com/VenusProtocol/oracle/commit/c1f924a))
* chore(release): 2.16.0-dev.1 [skip ci] ([6c112fc](https://github.com/VenusProtocol/oracle/commit/6c112fc))
* chore(release): 2.16.0-dev.2 [skip ci] ([970cf42](https://github.com/VenusProtocol/oracle/commit/970cf42))
* revert: undo yarn.lock oracle npm 2.15.0 fix commits ([5d84dec](https://github.com/VenusProtocol/oracle/commit/5d84dec))
* revert: yarn.lock changes ([e234339](https://github.com/VenusProtocol/oracle/commit/e234339))
* fix: [VLC-32] document OneJumpOracle.INTERMEDIATE_ORACLE ratio precondition ([007a6f2](https://github.com/VenusProtocol/oracle/commit/007a6f2))
* fix: [VLC-47] document that updateAssetPrice() success doesn't guarantee snapshot advancement ([165b7c5](https://github.com/VenusProtocol/oracle/commit/165b7c5))
* fix: [VLC-49] Documented same-transaction price-freshness guarantee not upheld by the cache logic in ([ddbf66d](https://github.com/VenusProtocol/oracle/commit/ddbf66d))
* fix: [VLC-56] CorrelatedTokenOracle.setSnapshot() lacks input validation, allowing silent cap-disabl ([de41efd](https://github.com/VenusProtocol/oracle/commit/de41efd))
* fix: regenerate yarn.lock to resolve oracle workspace aliasing ([e91edb6](https://github.com/VenusProtocol/oracle/commit/e91edb6))
* fix: test validate max-rate and timestamp in setSnapshot() ([39ba374](https://github.com/VenusProtocol/oracle/commit/39ba374))
* fix: update yarn.lock with oracle npm 2.15.0 split entry ([742dd0e](https://github.com/VenusProtocol/oracle/commit/742dd0e))
* docs: add Certik Core pool re-audit report (2026-06-16) ([76f1d8f](https://github.com/VenusProtocol/oracle/commit/76f1d8f))
...
* Merge pull request #291 from VenusProtocol/fix/etherscan-verify ([218740e](https://github.com/VenusProtocol/oracle/commit/218740e)), closes [#291](https://github.com/VenusProtocol/oracle/issues/291)
* Merge pull request #295 from VenusProtocol/main ([be45d94](https://github.com/VenusProtocol/oracle/commit/be45d94)), closes [#295](https://github.com/VenusProtocol/oracle/issues/295)
* Merge pull request #296 from VenusProtocol/chore/fix-release ([fb4cc0d](https://github.com/VenusProtocol/oracle/commit/fb4cc0d)), closes [#296](https://github.com/VenusProtocol/oracle/issues/296)
* Merge pull request #298 from VenusProtocol/feat/wbeth-oracle ([a359efb](https://github.com/VenusProtocol/oracle/commit/a359efb)), closes [#298](https://github.com/VenusProtocol/oracle/issues/298)
* Merge pull request #300 from VenusProtocol/feat/usdt-chainlink-oracle-deployment ([85ac7ac](https://github.com/VenusProtocol/oracle/commit/85ac7ac)), closes [#300](https://github.com/VenusProtocol/oracle/issues/300)
* Merge pull request #301 from VenusProtocol/chore/slim-package ([0d32fd1](https://github.com/VenusProtocol/oracle/commit/0d32fd1)), closes [#301](https://github.com/VenusProtocol/oracle/issues/301)
...
* Merge pull request #312 from VenusProtocol/develop ([94cf294](https://github.com/VenusProtocol/oracle/commit/94cf294)), closes [#312](https://github.com/VenusProtocol/oracle/issues/312)
...
* chore(release): 2.14.1-dev.1 [skip ci] ([ed9fcd0](https://github.com/VenusProtocol/oracle/commit/ed9fcd0))
* chore(release): 2.15.0-dev.1 [skip ci] ([da9d5cc](https://github.com/VenusProtocol/oracle/commit/da9d5cc))
* chore(release): 2.15.0-dev.2 [skip ci] ([1c4b0e5](https://github.com/VenusProtocol/oracle/commit/1c4b0e5))
* chore(release): 2.15.0-dev.3 [skip ci] ([2c89472](https://github.com/VenusProtocol/oracle/commit/2c89472))
* chore(release): 2.15.0-dev.4 [skip ci] ([2df94aa](https://github.com/VenusProtocol/oracle/commit/2df94aa))
* chore(release): 2.15.0-dev.5 [skip ci] ([c7cf14d](https://github.com/VenusProtocol/oracle/commit/c7cf14d))
* chore(release): 2.15.0-dev.6 [skip ci] ([15ff4fc](https://github.com/VenusProtocol/oracle/commit/15ff4fc))
* chore(release): 2.15.0-dev.7 [skip ci] ([bbd7ad7](https://github.com/VenusProtocol/oracle/commit/bbd7ad7))
* chore(release): 2.15.0-dev.8 [skip ci] ([3b0ca34](https://github.com/VenusProtocol/oracle/commit/3b0ca34))
...
* feat: add slim package scripts ([ed14178](https://github.com/VenusProtocol/oracle/commit/ed14178))
...
* feat: finish usdt chainlink oracle deployment script and corresponding deployment ([3756352](https://github.com/VenusProtocol/oracle/commit/3756352))
...
* feat: updating deployment files ([37a2bc6](https://github.com/VenusProtocol/oracle/commit/37a2bc6))
* feat: updating deployment files ([f961fec](https://github.com/VenusProtocol/oracle/commit/f961fec))
* feat: updating deployment files ([161a69d](https://github.com/VenusProtocol/oracle/commit/161a69d))
...
* fix: add repo URL ([dee1291](https://github.com/VenusProtocol/oracle/commit/dee1291))
* fix: Allow min == max == spot in keeper bound updates ([8563c8c](https://github.com/VenusProtocol/oracle/commit/8563c8c))
* fix: deploy wbeth oracle ([b1b62d3](https://github.com/VenusProtocol/oracle/commit/b1b62d3))
* fix: enable sourcify ([3b3bc87](https://github.com/VenusProtocol/oracle/commit/3b3bc87))
* fix: fixed etherscan verification ([757fd98](https://github.com/VenusProtocol/oracle/commit/757fd98))
* fix: fixed hardhat config ([f8a4683](https://github.com/VenusProtocol/oracle/commit/f8a4683))
* fix: fixed yarn.lock ([0bc0d7d](https://github.com/VenusProtocol/oracle/commit/0bc0d7d))
* fix: fixed yarn.lock ([3c85969](https://github.com/VenusProtocol/oracle/commit/3c85969))
...
* fix: merge conflict ([509402e](https://github.com/VenusProtocol/oracle/commit/509402e))
* fix: merge conflict ([f462ef3](https://github.com/VenusProtocol/oracle/commit/f462ef3))
* fix: release ([241a9e7](https://github.com/VenusProtocol/oracle/commit/241a9e7))
* fix: removed etherscan verify ([1961046](https://github.com/VenusProtocol/oracle/commit/1961046))
* fix: revert testnet ([5f271ea](https://github.com/VenusProtocol/oracle/commit/5f271ea))
...
* cd: publish slim package ([8beb8b4](https://github.com/VenusProtocol/oracle/commit/8beb8b4))
...
* remove hardhat-gas-reporter, not compatible with smock 2.4.0 ([80cd2c0](https://github.com/VenusProtocol/oracle/commit/80cd2c070e9d622c95cfa8852371ee8d9a2a52c6))
...
* deployed generic oracles on ethereum ([a61413b](https://github.com/VenusProtocol/oracle/commit/a61413bc65ca14b26be9ceb02e15ecf3b691072f))
...
* fixed one jump oracle scripts ([e700465](https://github.com/VenusProtocol/oracle/commit/e700465b06e8c0685963de58ec371ba84af1eab4))
...
* remove unused param ([58dbffb](https://github.com/VenusProtocol/oracle/commit/58dbffb1ce350b47d13a30ae87c5d97daba6a35c))
...
* VPB-04 ([e417976](https://github.com/VenusProtocol/oracle/commit/e417976e5b4bb11ae0fd61dbdc8eec56e7d34de1))
...
## [2.13.0-dev.8](https://github.com/VenusProtocol/oracle/compare/v2.13.0-dev.7...v2.13.0-dev.8) (2025-06-27)
