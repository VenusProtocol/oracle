...
export const ADDRESSES: PreconfiguredAddresses = {
  bsctestnet: {
    ...
    // Hub_USDT, the only Venus Hub vault deployed on testnet. Its share token is named
    // "Vault Share" / vSHARE with 12 decimals, and it stands in for mainnet's vhUSDT.
  ...
  bscmainnet: {
    ...
    vhUSDC: "0x9D2D9592cF8DFbf59107fAab703d08494BE14617",
    vhU: "0x0e5AA174d4F31b757a237eb1999DE151596788B0",
  },
  sepolia: {
